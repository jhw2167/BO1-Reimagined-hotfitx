...
init()
{
	...
	//spawn_perk( "p6_zm_vending_electric_cherry", "zombie_vending", "vending_electriccherry", "specialty_grenadepulldeath", "mus_perks_cherry_jingle", "mus_perks_cherry_sting" );
	//spawn_perk( "p6_zm_vending_vultureaid", "zombie_vending", "vending_vulture", "specialty_scavenger", "mus_perks_vulture_jingle", "mus_perks_vulture_sting" );
